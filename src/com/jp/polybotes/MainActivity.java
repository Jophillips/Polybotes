...
public class MainActivity extends Activity {
	...
	String strSummary = "";
			...
			public void printButtons()
			{
				...
				final TextView buttonOne = (TextView) findViewById(R.id.buttonBackCredits);
				final TextView buttonTwo = (TextView) findViewById(R.id.button2);
				final TextView buttonThree = (TextView) findViewById(R.id.button3);
				final TextView buttonFour = (TextView) findViewById(R.id.button4);
				final TextView textOne = (TextView) findViewById(R.id.textQuestion);
				final TextView textThree = (TextView) findViewById(R.id.textAnswers);	
			...
			//makes it full screen
				...
				pushMe4.setOnClickListener(new View.OnClickListener() {
				 ...
				 new CountDownTimer(180000, 1000) {
					 TextView textCountDown = (TextView) findViewById(R.id.textCountDown);
				     public void onTick(long millisUntilFinished) {
				         textCountDown.setText("Time remaining: " + millisUntilFinished / 1000 + "s");
				     }

				     public void onFinish() {
				    	 textCountDown.setText("Time remaining: 0s");
							Intent MainAct = new Intent(MainActivity.this, AnswersScreen.class);
